...
test('composeReview builds a JSON-shaped weekly-review prompt from context', () => {
  const ctx = {
    ...
    metrics: [
      { label: 'Sleep', thisWeek: 6.8, lastWeek: 7.4, change: -0.08, goodWhen: 'up' },
      { label: 'Net worth', thisWeek: 212000, lastWeek: 210000, change: 0.0095, goodWhen: 'up' },
    ],
  ...
  assert.match(prompt, /Sleep: 6.8 \(-8% vs last week\)/);
