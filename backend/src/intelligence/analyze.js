  ...
  for (const [key, series] of Object.entries(seriesByKey)) {
    ...
    findings.push({
      ...
      evidence: {
        ...
        metric: key,
        date: latestDayKey,
        unit: cat.unit(domain, metric),
        anomalyKey: `anomaly:${key}:${latestDayKey}`,
...
async function analyze(opts = {}) {
  ...
  const COMPOSITE_TYPES = ['recovery', 'sleep_debt', 'sleep_consistency', 'sleep_regularity', 'training_load', 'strain', 'fitness'];
