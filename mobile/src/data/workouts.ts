...
export const SESSION_A: StrengthSession = {
  ...
  working: [
    ...
    },
    {
      ...
      rest: '45 sec',
      load: 'Bodyweight',
      cue: 'Hip adductor + lateral core. No cervical involvement. Top leg on bench, bottom leg elevated.',
    },
  ],
};
  ...
  working: [
    {
      ...
      rest: '60 sec',
      load: '10–20 lb DB',
      cue: 'Most important longevity exercise. Chin tucked, eyes at 45° down — never look up. Hinge from hip, flat back, slow descent.',
    },
    {
      ...
      rest: '75 sec',
      load: 'Light-moderate',
      cue: 'V-bar or neutral handle. Reduces C5 nerve tension vs supinated grip. Chest tall, no forward lean, no cervical flexion under load.',
    },
    {
      ...
      rest: '60 sec',
      load: 'Bodyweight',
      cue: 'Actively depress and elevate scapulae. Do NOT relax into passive hang.',
    },
    {
      name: 'Farmer carry',
      sets: '3 × 30 sec',
      rest: '60 sec',
      load: 'Moderate DB each hand',
      cue: 'Eyes forward, chin slightly tucked, shoulders back and down. Active cervical rehab. Walk tall. No Valsalva.',
    },
  ],
};
...
export const MOBILITY: MobilitySession = {
  id: 'mobility',
  label: 'Mobility + Stability + PT',
  duration: '~40 min',
  note: 'Active recovery — supports PT protocol. Fine to do in the evening.',
  exercises: [
    { name: 'Diaphragmatic breathing (supine)', sets: '3 × 10 breaths', cue: 'Pelvic floor drop on inhale, gentle lift on exhale.' },
    { name: '90/90 hip stretch', sets: '3 × 60 sec each side', cue: 'Posterior hip capsule. Key for pelvic floor decompression.' },
    { name: 'Hip flexor kneeling stretch', sets: '3 × 60 sec each side', cue: 'Anterior chain release. Tight hip flexors compress pelvic floor.' },
    { name: 'Side-lying clamshells', sets: '3 × 15 each side', cue: 'Glute medius. Resist pelvis rotating backward.' },
    { name: 'Dead bug (contralateral)', sets: '3 × 8 each side', cue: 'Full lumbar contact on floor. Exhale completely on extension.' },
    { name: 'Cat-cow spinal flow', sets: '3 × 10 slow', cue: 'Full segmental movement. Decompress lumbar spine.' },
    { name: 'Thoracic rotation (seated)', sets: '3 × 10 each side', cue: 'Rotate through T-spine only. Compensates for desk posture.' },
    { name: 'Chin tucks', sets: '3 × 10 (hold 3 sec)', cue: 'Cervical lordosis restoration. Draw chin straight back.' },
    { name: 'Single-leg balance', sets: '3 × 30 sec each', cue: 'Eyes open → closed. Proprioception and ankle stability.' },
    { name: 'Supine pelvic floor drop breathing', sets: '5 min', cue: 'From PT protocol. Slow exhale with conscious pelvic floor release.' },
  ],
};
