...
const styles = StyleSheet.create({
  ...
  chipBadge: {
    fontSize: 12, fontWeight: '800', letterSpacing: 0.6, borderWidth: 1,
    borderRadius: radius.sm, paddingHorizontal: 5, paddingVertical: 2, marginRight: spacing.sm,
  },
  bubble: { borderRadius: radius.lg, paddingHorizontal: spacing.md, paddingVertical: 14, marginTop: spacing.md, maxWidth: '94%' },
  ...
  startersLabel: { fontSize: 12, fontWeight: '700', letterSpacing: 1.0, marginBottom: 5 },
  ...
  micCaption: { fontSize: 12, fontWeight: '600' as const, marginTop: 2 },
});
